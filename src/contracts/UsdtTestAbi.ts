...
export interface UsdtTestAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface UsdtTestAbi extends BaseContract {
  connect(runner?: ContractRunner | null): UsdtTestAbi;
  waitForDeployment(): Promise<this>;

  interface: UsdtTestAbiInterface;
